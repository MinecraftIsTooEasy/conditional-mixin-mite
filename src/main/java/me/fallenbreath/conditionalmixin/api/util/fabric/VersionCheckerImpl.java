...
//		return FabricLoader.getInstance().getModContainer(modId).map(c -> c.getMetadata().getVersion().getFriendlyString());
        return FishModLoader.getModContainer(modId).map(c -> c.getMetadata().getVersion().getFriendlyString());
    }
...
//		Optional<ModContainer> mod = FabricLoader.getInstance().getModContainer(modId);
        Optional<ModContainer> mod = FishModLoader.getModContainer(modId);
